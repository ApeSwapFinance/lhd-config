...
const verifiedAssets: AddressMapping[] = [
  ...
  },
  {
    tokenSymbol: 'WIN',
    tokenName: 'Winston',
    tokenLogoUrl: 'https://raw.githubusercontent.com/ApeSwapFinance/lhd-config/main/logos/WINSTON.svg',
    tokenAddresses: [{ address: '0x75578ebBefe274F240B8E1b5859cA34f342157D9', chainId: '56' }],
    knownOwners: ['0x75578ebBefe274F240B8E1b5859cA34f342157D9', '0xF9B9eE3B0301B511cd5AA4b8D039F63df19C615a'],
